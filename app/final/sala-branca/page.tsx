...
export default function SalaBrancaPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Home button */}
      <button type="button" onClick={() => router.push("/?screen=home")} className="absolute top-[42px] left-3 z-40 w-9 h-9 rounded-full bg-black/20 backdrop-blur flex items-center justify-center" aria-label="Voltar para inicio">
