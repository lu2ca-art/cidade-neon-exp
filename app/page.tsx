        ...
        <div className="w-full max-w-[100vw] md:max-w-[400px] h-[100dvh] md:h-[844px] bg-gradient-to-b from-[#1C1C1E] to-black flex flex-col relative" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}>
          ...
          <div className="px-6 pb-10">
            ...
            <div className="flex justify-center">
              <button type="button" onClick={() => { if (callAudioRef.current) { callAudioRef.current.pause(); callAudioRef.current = null } if (callTimerRef.current) clearInterval(callTimerRef.current); setPhase("hacker"); updateCinematicStep("hacker-takeover") }} className="w-[72px] h-[72px] rounded-full bg-[#FF3B30] flex items-center justify-center active:scale-95 transition-transform">
