  ...
  nizzy: {
    ...
    preMission: {
      messages: [
        ...
        "abre o B4TIDA.",
        "tem uma batida escondida ali. voce monta ela de novo, pista por pista.",
        "nao tem certo ou errado. so tem no tempo ou fora dele.",
        "me mostra que voce escuta de verdade.",
      ],
      appName: "B4TIDA",
      appRoute: "/batida",
      appId: "feel-good-app",
      ctaLabel: "Abrir B4TIDA",
    },
    reward: {
      messages: [
